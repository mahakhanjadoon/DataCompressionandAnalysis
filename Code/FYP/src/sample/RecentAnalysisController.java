...
public class RecentAnalysisController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
       ...
       lineChartBtn.setSelected(true);
        ...
        for(int i=0; i<=9; i++) {
            ...
            String x = x1.get(i + "_", null);
            String y = y1.get(i + ".", null);

            axis1[i][0]= x;
            axis1[i][1]=y;

            System.out.println(axis1[i][0] + " " + axis1[i][1]);
        ...
        for(int k=0; k<=9; k++){
            ...
            String x = x2.get(k+"-", null);
            String y = y2.get(k+"=", null);

            axis2[k][0] = x;
            axis2[k][1] = y;
            System.out.println(axis2[k][0] + " " + axis2[k][1]);
        }
        for(int l=0; l<=9; l++) {
            ...
            String x = x3.get(l + "*", null);
            String y = y3.get(l + "+", null);

            axis3[l][0] = x;
            axis3[l][1] = y;

            System.out.println(axis3[l][0] + " " + axis3[l][1]);
        }
        setInitialChart();
    }
